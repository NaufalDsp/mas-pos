      ...
      <div class="flex items-center justify-between pb-4 border-b border-gray-300">
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex items-center divide-x-2 divide-gray-300">
            ...
            <button type="button" aria-label="Keranjang"
              class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition flex items-center gap-2 mr-3">
              ...
              <span class="text-sm font-medium">Total Tagihan {{ totalTagihan }}</span>
            </button>
            ...
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center bg-gray-50 hover:bg-gray-100 transition cursor-pointer"
              ...
              <div v-if="!imagePreview" class="flex flex-col items-center">
                ...
                <p class="text-sm text-gray-600 mb-1">
                  Seret & Letakan atau klik <span class="text-blue-600 font-medium">Pilih File</span> untuk diunggah
                </p>
