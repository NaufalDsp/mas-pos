              ...
              <Dropdown align="right" width="48">
                <template #trigger="{ open }">
                  <button type="button"
                    ...
                    <svg class="h-4 w-4 text-gray-500 transition-transform duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                      fill="currentColor" :class="open ? 'rotate-180' : ''">
